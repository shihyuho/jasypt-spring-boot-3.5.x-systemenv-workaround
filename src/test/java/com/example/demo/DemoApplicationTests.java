...
@SetEnvironmentVariable(key = "SERVER",
		value = "${ENC(XpovJN5AbC5mFBWOZhyKI+2/6MNIcuM8I3WD2aTgtK/s4iuDx7irPX9ft9c0yDOH)}")
@SetEnvironmentVariable(key = "SERVER_PORT",
		value = "${ENC(XpovJN5AbC5mFBWOZhyKI+2/6MNIcuM8I3WD2aTgtK/s4iuDx7irPX9ft9c0yDOH)}")
@SetEnvironmentVariable(key = "HOST_0",
		value = "${ENC(XpovJN5AbC5mFBWOZhyKI+2/6MNIcuM8I3WD2aTgtK/s4iuDx7irPX9ft9c0yDOH)}")
@SetEnvironmentVariable(key = "HOST_0_1",
		value = "${ENC(XpovJN5AbC5mFBWOZhyKI+2/6MNIcuM8I3WD2aTgtK/s4iuDx7irPX9ft9c0yDOH)}")
@SetEnvironmentVariable(key = "HOST_0_NAME",
		value = "${ENC(XpovJN5AbC5mFBWOZhyKI+2/6MNIcuM8I3WD2aTgtK/s4iuDx7irPX9ft9c0yDOH)}")
@SetEnvironmentVariable(key = "HOST_F00_NAME",
		value = "${ENC(XpovJN5AbC5mFBWOZhyKI+2/6MNIcuM8I3WD2aTgtK/s4iuDx7irPX9ft9c0yDOH)}")
@SetEnvironmentVariable(key = "S-ERVER",
		value = "${ENC(XpovJN5AbC5mFBWOZhyKI+2/6MNIcuM8I3WD2aTgtK/s4iuDx7irPX9ft9c0yDOH)}")
@SetEnvironmentVariable(key = "S-ERVER",
		value = "${ENC(XpovJN5AbC5mFBWOZhyKI+2/6MNIcuM8I3WD2aTgtK/s4iuDx7irPX9ft9c0yDOH)}")
@SpringBootTest({ "myserver=ENC(XpovJN5AbC5mFBWOZhyKI+2/6MNIcuM8I3WD2aTgtK/s4iuDx7irPX9ft9c0yDOH)",
